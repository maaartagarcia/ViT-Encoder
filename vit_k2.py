...
# input_shape = (32, 32, 3) # Size of Images. Substitute with (256, 256, 3)

#(x_train, y_train), (x_test, y_test) = keras.datasets.cifar100.load_data()

f = h5py.File('./dataset_for_vit.hdf5', 'r')
...
learning_rate = 0.001
weight_decay = 0.0001
batch_size = 16 # Substitute with 16
...
class Patches(layers.Layer):
    ...
    def call(self, images):
        ...
        # Modified
        # Expected float32, received int32
        # Cast Using tensorflow.keras.backend
...
# Image must be a Tensor in order to pass it to ops.image.resize
# First dimension of Input Image, indicates the size of the batch,
# For the 'Patches' Layer
# (1, 72, 72, 3) --> batch_size = 1
